...
const Confidential = () => {
  return (
    <main className="confidential">
      <section className="confidential-mentions">
        <article>
          <h2>Politique de confidentialité</h2>
          <p>Echange Et confiance</p>
        </article>
        <article>
        ...
        <article>
          ...
          <aside>
            ...
            <p>
              Les données personnelles collectées dans le cadre de notre
              activité sont les suivantes : [Listez les données collectées lors
            ...
            <p>
              ...
              laquelle/lesquelles la collecte de données personnelles est
              nécessaire dans le cadre de votre activité]
            </p>
            <p>
              Exemple : gestion de contrat, gestion de l’espace client, suivi de
              la qualité des services, envoi de newsletter, etc.
            </p>
          </aside>
          <aside>
            ...
            <p>
              ...
              les données suivantes : [Liste des données automatiquement
              collectées lors de la simple visite de l’utilisateur sur le site]
            </p>
            <p>
              D’autres données personnelles sont collectées lorsque vous
              effectuez les opérations suivantes sur la plateforme : [Lister les
              données personnelles collectées, et préciser la finalité de la
              collecte]
            </p>
            <p>
              Elles sont conservées par le responsable du traitement dans des
              conditions raisonnables de sécurité, pour une durée de : [Indiquer
          ...
          <aside>
            ...
            <p>
              Le site [nom du site web] est hébergé par : [Dénomination sociale
              de l’entreprise Adresse du siège social Contact (adresse email
            ...
            <p>
              ...
              “Article 3.4 : Transmission des données à des tiers” : “Les
              données peuvent être transmises à nos partenaires, ci-après
              énumérés :”]
            </p>
            <p>
              [Si le site est concerné par l’utilisation de cookies, préciser
              leur utilisation dans un
              <strong>Article 3.5 : Politique en matière de “cookies”] </strong>
            </p>
          </aside>
        </article>
        <article>
          ...
          <aside>
            ...
            <p>
              Les données à caractère personnelles sont collectées par [raison
              ou dénomination sociale de l’entreprise], [forme juridique] au
        ...
        <article>
          ...
          <ul>
            ...
            <p>
              Pour exercer vos droits, veuillez adresser votre courrier à [Nom
              et adresse de l’entreprise] ou par mail à [Insérer l’adresse
              e-mail du Délégué à la protection des données]
            </p>
            <p>
              Afin que le responsable du traitement des données puisse faire
              droit à sa demande, l’utilisateur peut être tenu de lui
              communiquer certaines informations telles que : ses noms et
              prénoms, son adresse e-mail ainsi que son numéro de compte,
