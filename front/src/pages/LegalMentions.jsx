...
const LegalMentions = () => {
  return (
    <main className="legal-mentions">
      <section className="form-legal-mentions">
        ...
        <article>
          <p>
            ...
            https://echangeetconfiance.fr , ci-après le "Site", les présentes
            mentions légales.
          </p>
          <p>
        ...
        <article>
          ...
          <p>
            ...
            Plassais Vicky, domiciliée mqlsdjldkjfm, dont le numéro de téléphone
            est 0600000000, et l'adresse e-mail azerty@azerty.fr.
          </p>
        ...
        <article>
          ...
          <p>
            L'hébergeur du Site est la société 3wa, dont le siège social est
            situé au paris , avec le numéro de téléphone : 0100000000 + adresse
            mail de contact
          </p>
        </article>
        <article>
        ...
        <article>
          ...
          <p>
            ...
            https://echangeetconfiance.fr accessible à la rubrique "CGU" Pour
            plus d'informations en matière de protection des données à caractère
            personnel , se reporter à la Charte en matière de protection des
            données à caractère personnel du site https://echangeetconfiance.fr
            accessible à la rubrique "Données personnelles" Pour plus
            d'informations en matière de cookies, se reporter à la Charte en
            matière de cookies du site https://echangeetconfiance.fr accessible
